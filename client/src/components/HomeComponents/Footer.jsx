...
export default function Footer() {
    return (
        <footer className="bg-blue-900 pt-20 pb-10 border-t border-white/10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-16">
                    ...
                    <div className="col-span-2 lg:col-span-2">
                        <Link href="/" className="inline-block mb-6">
                            <span className="font-heading font-black text-2xl tracking-tight text-white">
                                Eva <span className="text-blue-500">.</span>
                            </span>
                        </Link>
                        <p className="text-slate-400 text-sm leading-relaxed max-w-sm mb-6">
                            The intelligent OS for startup validation. Discover competitors, analyze market gaps, and validate your next big idea with AI-driven insights.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><a href="#" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">Integrations</a></li>
                            <li><a href="#" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">Pricing</a></li>
                            <li><a href="#" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">Changelog</a></li>
                            <li><a href="#" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">Docs</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><a href="#" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">Blog</a></li>
                            <li><a href="#" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">Contact</a></li>
                            <li><a href="#" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">Partners</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><a href="#" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">Security</a></li>
                        </ul>
                    </div>
                </div>
